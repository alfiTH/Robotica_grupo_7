...
using TuplePrx = std::tuple<RoboCompCameraRGBDSimple::CameraRGBDSimplePrxPtr,RoboCompDifferentialRobotMulti::DifferentialRobotMultiPrxPtr,RoboCompLaserMulti::LaserMultiPrxPtr,RoboCompYoloObjects::YoloObjectsPrxPtr>;
